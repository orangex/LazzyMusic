...
8. 在设置中有一项叫做通过端口转发从外网访问，什么意思？我没有公网 IP 可以吗？
    ...
    所以，想要通过该方式从外网访问，一定需要公网 IP，目前国内的现状是普遍需要自行向运营商申请(申请到的是动态 IP也可以的)，申请方法和申请后的光猫改桥接等配置操作网络上有很多经验贴可以参考，这可能是最有门槛的事情了，如果你想外网访问的话。不过 LazzyMusic 并不要求公网 IP 是静态的， 这也是前面提到的要登录的原因之一。
