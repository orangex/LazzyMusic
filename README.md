...
正如其名，我折腾是想大家不用折腾，LazzyMusic 是一个自带客户端（播放器）的，多平台的，无需复杂部署的本地音乐流媒体服务。

你可以从不同的设备访问和播放你在电脑上的音乐收藏，支持视频，支持订阅外部音乐，支持元信息刮削和编辑。
...
- 媒体信息刮削与编辑：
    ...
    - **快速匹配与编辑**：提供最优匹配结果（多信息源关键词匹配+声纹匹配），一键应用整条结果或自由指定结果中的歌手，专辑，歌词等。
    - 支持歌曲和专辑多位歌手，支持专辑多音轨
